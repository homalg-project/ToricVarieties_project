########################################################################################
##
##  DegreeXLayer.gi         ToricVarieties package
##
##  Copyright 2015- 2016, Sebastian Gutsche, TU Kaiserslautern
##                        Martin Bies,       ITP Heidelberg
##
##  Chapter Truncations of f.p. graded left/right modules (morphisms) to a single degree
##
########################################################################################
...
InstallMethod( WriteDegreeXLayerOfProjectiveGradedLeftOrRightModuleMorphismToFileForMAGMA,
  ...
  function( variety, projective_module_morphism, degree, filename )
    ...
    if Length( gens_source ) = 0 then
      ...
      path := PackageInfo( "ToricVarieties" )[ 1 ]!.InstallationPath;
