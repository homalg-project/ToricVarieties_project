...
#! <A graded left module presentation over the ring Q[x_1,x_2,x_3,x_4] 
#! (with weights [ [ 1, 0 ], [ 1, 0 ], [ 0, 1 ], [ 0, 1 ] ])>
Hi( P1, CForCAP, 0, false );
#! [ 1, <A vector space object over Q of dimension 1> ]
Hi( P1xP1, C2ForCAP, 0, false );
#! [ 1, <A vector space object over Q of dimension 1> ]
Hi( P1xP1, VForCAP, 0, false );
#! [ 0, <A vector space object over Q of dimension 4> ]
Hi( P1xP1, VPrimeForCAP, 0, false );
#! [ 0, <A vector space object over Q of dimension 4> ]
AllHi( P1, CForCAP, false );
#! Computing h^0
#! ----------------------------------------------
#!
#! Computing h^1
#! ----------------------------------------------
#!
#! Finished all computations. Summary: 
#! h^0 = 1
#! h^1 = 0
#! [ [ 1, <A vector space object over Q of dimension 1> ],
#!   [ 1, <A vector space object over Q of dimension 0> ] ]
AllHi( P1xP1, C2ForCAP, false );
#! Computing h^0
#! ----------------------------------------------
#!
#! Computing h^1
...
#!   [ 1, <A vector space object over Q of dimension 1> ],
#!   [ 1, <A vector space object over Q of dimension 0> ] ]
AllHi( P1xP1, VPrimeForCAP, false );
#! Computing h^0
#! ----------------------------------------------
#!
#! Computing h^1
