##########################################################################################
##
##  TruncationFunctor.gi               TruncationsOfFPGradedModules package
##
...
InstallMethod( TruncationFunctorForGradedRowsAndColumns,
  ...
  function( variety, degree, graded_row )
    ...
    if not IsComplete( variety ) then
      ...
      Error( Concatenation( "Currently this functor is only defined for FPGradedModules defined over the Cox ring of a COMPLETE toric variety,",
