...
// Count root distribution
std::vector<unsigned long long int> RootDistributionCounter( WeightedDiagram dia, int w0, int h0_target )
{
...
void DistributionDistributer( WeightedDiagram dia, std::vector<int> ws, int h0_target )
{
...
std::vector<unsigned long long int> countRootDistribution( WeightedDiagram dia, int NUM_THREADS, int h0_target )
{
...
std::vector<unsigned long long int> countRootDistribution( WeightedDiagram dia, int h0_target )
{
