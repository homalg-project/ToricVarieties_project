...
int main(int argc, char* argv[]) {
    ...
    if ( input[ 2 + 2 * numberVertices + 2 * numberEdges + 2 ] > 0 ){
        n = countRootDistribution( dia, input[ 2 + 2 * numberVertices + 2 * numberEdges + 2 ], input[ 2 + 2 * numberVertices + 2 * numberEdges + 3 ] );
    }
    else{
        n = countRootDistribution( dia, input[ 2 + 2 * numberVertices + 2 * numberEdges + 3 ] );
    }
