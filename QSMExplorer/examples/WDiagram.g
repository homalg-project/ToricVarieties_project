...
#! @Example
n := CountDistribution( [ 0, 0 ], [ 4, 4 ], [ [ 0, 1 ], [ 0, 1 ] ], 1, 2, 20 );;
n;
...
#! @Example
n1 := CountDistribution( [ 0,0,0 ], [ 16, 16, 16 ], [ [0,1], [0,1], [0,1], [0,1], [0,2], [1,2] ], 4, 8, 8 );;
n1;
#! [ 2030, 70, 0, 0, 0, 0 ]
n2 := CountDistribution( [ 0,0,0,0 ], [ 16, 16, 16, 16 ], [ [0,1], [0,1], [0,1], [0,1], [0,2], [1,2], [0,3], [1,3] ], 5, 8, 8 );;
n2;
#! [ 9331, 5334, 42, 0, 0, 0 ]
n3 := CountDistribution( [ 0,0,0 ], [ 36, 8, 36 ], [ [0,1], [0,1], [0,1], [0,1], [0,2], [1,2] ], 4, 16, 8 );;
n3;
#! [ 8080, 28631, 7552, 34, 0, 0 ]
n4 := CountDistribution( [ 0,0,0 ], [ 34, 8, 38 ], [ [0,1], [0,1], [0,1], [0,1], [0,2] ], 4, 16, 8 );;
n4;
#! [ 0, 1547, 1582, 35, 0, 0 ]
#! @EndExample
