...
#! @Example
CountDistributionWithExternalLegs( [ [ 0,0,0 ], [ 16, 16, 16 ], [ [0,1], [1,2], [2,0] ], 1, 8, 8, [ 0, 0, 1 ], [ 2, 2, 4 ] ] );;
#! @EndExample
...
#! @Example
n := CountDistributionWithExternalLegs( [ [ 0,0,0,1 ], [ 16, 16, 16, 16 ], [ [0,1], [1,2], [2,0], [0,3], [1,3], [0,4], [4,2] ], 5, 8, 8, [ 0, 0, 3 ], [ 2, 2, 4 ] ] );;
n;
#! [ 0, 13652, 64, 0, 0, 0 ]
#! @EndExample
